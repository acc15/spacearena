...
class FontGeneratorWorker extends SwingWorker<FontGeneratorResult, Object> {
    ...
    protected FontGeneratorResult doInBackground() throws Exception {
        ...
        final FontData fd = FontGenerator.computeFontData(input.getFont(), 1024, input.getPad(), input.getAlphabet());
        ...
        final BufferedImage df2 = DeadReckoning.resizeTo(dfi, input.getImageScale());
