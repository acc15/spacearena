 ...
 *     <li>removing methods and parameters which are not in subset of native Android GLES2 implementation and JOGL GL2
...
public interface OpenGL {
    ...
    void glGenRenderbuffers(int length, int[] bufs, int offset);
    ...
    void glBindRenderbuffer(int buf);
    void glRenderbufferStorage(int format, int width, int height);

    void glBindFramebuffer(int buf);
